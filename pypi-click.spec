...
Source0  : https://files.pythonhosted.org/packages/60/6c/8ca2efa64cf75a977a0d7fac081354553ebe483345c734fb6b6515d96bbc/click-8.2.1.tar.gz
...
%prep
%setup -q -n click-8.2.1
cd %{_builddir}/click-8.2.1
pushd ..
cp -a click-8.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747837019
