...
Source0  : https://files.pythonhosted.org/packages/b9/2e/0090cbf739cee7d23781ad4b89a9894a41538e4fcf4c31dcdd705b78eb8b/click-8.1.8.tar.gz
...
%prep
%setup -q -n click-8.1.8
cd %{_builddir}/click-8.1.8
pushd ..
cp -a click-8.1.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735094289
